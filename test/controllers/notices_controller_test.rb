...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { notice_detail: @notice.notice_detail, notice_name: @notice.notice_name, notice_type: @notice.notice_type } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { notice_detail: @notice.notice_detail, notice_name: @notice.notice_name, notice_type: @notice.notice_type } }
